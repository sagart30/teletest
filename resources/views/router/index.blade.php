                                            ...
                                            <div class="col-sm-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="col-sm-4 mt-30">
                                                            <a id="index" class="form-control btn btn-success btn-rounded btn-lable-wrap left-label pt-10" href="{{URL::route('router.create')}}">
                                                                <span class="btn-text">ADD</span> <span class="btn-label"><i class="fa fa-plus"></i> </span>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
